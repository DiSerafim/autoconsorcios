  ...
  return (
    <div className="container">
      <section id="header" className="text-center">
        <h3 className="title" title="Em observação">
          &gt; Em observação
        </h3>
      </section>
        ...
        <div className="products-container">
          <div className="card" data-name="c-1">
            ...
            <p className="cart-text">
              Mensam da notíciaMensam da notíciaMensam da notíciaMensam da
              notíciaMensam da notíciaMensam da notíciaMensam da notíciaMensam
              da notíciaMensam da notícia
            </p>
      ...
      <section className="preview">
        <div className="preview-card" data-target="c-1">
          ...
          <p className="cart-text">
            Mensam da notíciaMensam da notíciaMensam da notíciaMensam da
            notíciaMensam da notíciaMensam da notíciaMensam da notíciaMensam da
            notíciaMensam da notícia
          </p>
        </div>
